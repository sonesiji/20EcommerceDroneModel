...
#     list_display = ('product', 'hourly_rate', 'daily_rate', 'is_available', 'security_deposit')
#     search_fields = ('product__name',)
#     list_filter = ('is_available',)

# class RentalBookingAdmin(admin.ModelAdmin):
#     list_display = ('customer', 'rental_product', 'start_datetime', 'end_datetime', 'status', 'total_cost')
#     search_fields = ('customer__customer_name', 'rental_product__product__name')
#     list_filter = ('status',)

# admin.site.register(RentalProduct, RentalProductAdmin)
