...
from .views import rental_product_list, rental_booking
from .views import (
    generate_text,
    instructor_details,
    slot_booking,
...
path('query/', query_tool_page, name='query_tool_page'),
    ...
    path('rentals/', rental_product_list, name='rental_product_list'),
    path('rentals/book/<int:product_id>/', rental_booking, name='rental_booking'),
    path('ar-demo/', views.ar_demo_view, name='ar_demo'),
